...
| Component | License | GPL-3 compatible? | Use in Sesha |
|---|---|---|---|
...
### Python (Sesha MCP servers / memory)
```
mcp[cli]>=1.0
fastmcp>=0.1
chromadb>=1.5.9
...
|---|---|---|
| github.com/gaganjainse | your profile | AI/LLM engineer; NexusAOS, SeshaOS, Vyākṛti, RAG, eval harness |
| github.com/gaganjainse/Auto-desktopenv | this repo | fork of end-4; subject of this work |
...
| github.com/codecrafters-io/build-your-own-x | 537k★ tutorials | learning track for nexus-kernel/shell/DB |
...
| Repo | Role in the Sesha vision |
|---|---|
| **NexusAOS** | Governance/event-sourcing layer → Sesha audit log & policy (the bridge) |
| **SeshaOS** | Local-first specialist-model OS concept → informs model routing |
| **nexus-kernel** | Alpha microkernel track → long-term research, not daily driver |
| **rag-service** | Run locally as `sesha-memory` (RAG over notes/docs/projects) |
...
The single highest-leverage connection is **NexusAOS ↔ Sesha audit log**: it makes your desktop agent
