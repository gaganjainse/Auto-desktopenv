...
- [ ] Bootstrap command: `bash <(curl -s https://raw.githubusercontent.com/gaganjainse/shesh-desktop/main/tools/bootstrap.sh)`
- [ ] Username: `gagan`
...
- [ ] Bootstrap command noted: `bash <(curl -s https://raw.githubusercontent.com/gaganjainse/shesh-desktop/main/tools/bootstrap.sh)`
- [ ] Username: `gagan`
...
- All installer steps are logged to `~/Workspace/shesh-desktop/`
